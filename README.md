...
* `типы объектов недвижимости, относится к object` - Все актуальные типы объектов, находятся в поле под **ID=1**, это поле типа list. В атрибуте **List_values** находятся все типы объектов, актуальные на момент вызова.
